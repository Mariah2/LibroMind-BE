...
public partial class LibroMindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DAVID-LAPTOP;Database=LibroMind;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Borrow>(entity =>
        {
            ...
            entity.Property(e => e.WasExtensionRequested).HasColumnName("wasExtensionRequested");
